...
class ImageService {
  static Future<dynamic> uploadFile(filePath) async {
    ...
    try {
      FormData formData =
          FormData.fromMap({"image": await MultipartFile.fromFile(filePath, filename: "dp")});

      Response response = await Dio().put("https://appointella-api.herokuapp.com/customer/$_userId",
          data: formData,
